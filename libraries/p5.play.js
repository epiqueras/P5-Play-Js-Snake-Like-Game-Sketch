...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  // var print = pInstBind('print'); // Seems to break sketch.
...
function Animation(pInst) {
  ...
  */
  ...
  if(frameArguments.length === 2 && typeof frameArguments[0] === 'string' && typeof frameArguments[1] === 'string')
  {
    ...
    if(ext1 !== '.png')
    {
      console.log('Animation error: you need to use .png files (filename '+from+')');
      from = -1;
    }
    ...
    if(ext2 !== '.png')
    {
      console.log('Animation error: you need to use .png files (filename '+to+')');
      to = -1;
    }
  ...
  */
  ...
  this.draw = function(x, y, r) {
    ...
    if (this.visible)
    {
      ...
      {
        console.log('Warning undefined frame '+frame);
        //this.isActive = false;
      }
